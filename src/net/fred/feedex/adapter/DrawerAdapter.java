...
public class DrawerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.iconLogo = (TextView) convertView.findViewById(R.id.icontext);
        ...
        if (position == 0 || position == 1) {
            ...
            String lg = mFeedsCursor.getString(POS_NAME);
            lg=(lg.charAt(0)+"").toUpperCase();
            holder.iconLogo.setText(lg);
            ...
            if (mFeedsCursor.getInt(POS_IS_GROUP) == 1) {
                ...
                if (bitmap != null) {
                	...
                	holder.iconLogo.setVisibility(View.VISIBLE);
